...
export function SidebarMenuButton({
  ...
  const button = (
    <Comp data-slot="sidebar-menu-button" data-sidebar="menu-button" data-size={size} data-active={isActive}
  ...
  return (
    <div data-slot="sidebar-menu-badge" data-sidebar="menu-badge"
      className={cn(
        ...
        "peer-data-[size=lg]/menu-button:top-2.5", "group-data-[collapsible=icon]:hidden", className
      )} {...props}
    />
  )
}
