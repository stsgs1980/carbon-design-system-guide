...
- [Powered by Z.ai](#powered-by-zai)
- [Getting Started](#getting-started)
- [Project Structure](#project-structure)
- [Available Features & Components](#available-features-&-components)
- [Get Started with Z.ai](#get-started-with-zai)
- [Features](#features)
...
```bash
git clone https://github.com/stsgs1980/carbon-design-system-guide.git
cd carbon-design-system-guide
bun install
```
...
- **Database** - Prisma
- **Libraries** - shadcn/ui, Zustand, Framer Motion, Recharts, Zod, D3.js
- **Tools** - React
